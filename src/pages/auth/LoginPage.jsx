...
const LoginPage = () => {
  ...
  const getRegisterLink = () => {
    ...
    if (role === 'Admin') return '/admin/register'; // Assuming admin register exists or will exist
    ...
    <AuthLayout variant="login">
      <div className="flex justify-end mb-16">
        <p className="text-sm text-slate-500">
          No account? <Link to={getRegisterLink()} className="font-bold text-[#0F172A] hover:underline flex items-center gap-1 inline-flex">Register <ArrowRight size={14} /></Link>
        </p>
      </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <a href="#" className="text-xs font-bold text-slate-500 hover:text-[#0F172A] hover:underline">Forgot password?</a>
            </div>
            <div className="relative">
          ...
          <div className="flex items-center gap-3 pt-2">
            <input type="checkbox" id="remember" className="w-4 h-4 rounded text-[#0F172A] border-slate-300" defaultChecked />
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            New here? <Link to={getRegisterLink()} className="font-bold text-[#0F172A] hover:underline">Create an account</Link>
          </p>
